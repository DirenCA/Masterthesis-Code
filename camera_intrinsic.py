...
#TODO: take own checkerboard pictures and get my intrinsics
...
images = glob.glob(r"C:\Users\Diren\Nextcloud\HTW\4.Semester-Masterarbeit\Masterarbeit\Code\Chesspattern\My/*.jpg") #Quelle der Daten: https://github.com/opencv/opencv/tree/05b15943d6a42c99e5f921b7dbaa8323f3c042c6/samples/data
...
for fname in images:
    img = cv.imread(fname)
    img = cv.rotate(img, cv.ROTATE_90_COUNTERCLOCKWISE) # Quelle: https://github.com/nkmk/python-snippets/blob/addd28bee31e97b299383a57ffbddba49e03794c/notebook/opencv_rotate.py#L1-L20
